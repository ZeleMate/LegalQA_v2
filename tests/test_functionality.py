...
class TestBasicFunctionality:
    ...
    def test_database_manager_initialization(self):
        ...
        try:
            ...
            logger.error(f"❌ Database manager initialization failed: {e}", exc_info=True)
...
class TestProjectStructure:
    ...
    def test_pyproject_toml_dependencies(self):
        ...
        try:
            ...
            assert not missing_deps, f"Missing dependencies in pyproject.toml: {', '.join(missing_deps)}"
...
class TestErrorHandling:
    ...
    def test_database_connection_error_handling(self):
        ...
        logger.info("✅ DatabaseManager correctly propagated connection error from create_pool.")
